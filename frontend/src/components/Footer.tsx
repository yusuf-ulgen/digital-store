...
export default function Footer() {
  ...
  return (
    <>
      {/* İstatistik Bandı (Ürünler ile Aynı Arka Plan Tonu) */}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={s.label} className="flex items-center gap-4 group">
                <div className="w-12 h-12 rounded-xl bg-white flex items-center justify-center text-xl group-hover:bg-stone-100 transition-all border border-stone-200/50">
                  {s.icon}
                </div>
                <div>
                  <div className="font-black text-xl leading-none text-stone-950">{s.val}</div>
                  <div className="text-[10px] text-stone-500 font-bold uppercase tracking-widest mt-1">{s.label}</div>
                </div>
              </div>
            ))}
          </div>
      ...
      <footer className="bg-[#0A0A0A] text-white pt-6 pb-4 border-t border-white/5">
        {/* Easter Egg Popup */}
        {showEgg && (
        ...
        <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="lg:col-span-4 space-y-3">
              ...
              <div className="space-y-2.5">
                <a href="tel:05555555555" className="flex items-center gap-3 group">
                  <div className="w-8 h-8 rounded-xl bg-white/5 flex items-center justify-center group-hover:bg-white/10 transition-colors border border-white/5">
                    <Phone size={14} />
                  </div>
                  <div>
                    <div className="text-[9px] text-gray-500 font-bold uppercase leading-none mb-0.5">Bizi Arayın</div>
                ...
                <a href="mailto:destek@ulgenpaslanmaz.com" className="flex items-center gap-3 group">
                  ...
                  <div>
                    <div className="text-[9px] text-gray-500 font-bold uppercase leading-none mb-0.5">E-Posta Gönderin</div>
                ...
                <div className="flex items-center gap-3 group">
                  ...
                  <div>
                    <div className="text-[9px] text-gray-500 font-bold uppercase leading-none mb-0.5">Atölye</div>
          ...
          {/* Alt Bilgi */}
          <div className="pt-4 mt-1 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-3">
