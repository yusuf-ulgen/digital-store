...
export default function ChatWindow({ onClose }: Props) {
  ...
  const renderMessageContent = (message: any) => {
    // Eğer message.content string ise direkt döndür
    if (typeof message.content === "string") {
      return message.content;
    }

    // Eğer message.parts array ise, tüm text parçalarını birleştir
  ...
  return (
    <div className="flex h-[600px] w-[380px] flex-col overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-2xl sm:w-[400px]">
      {/* --- HEADER --- */}
